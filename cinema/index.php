...
<body>
    ...
    <div class="content">
        <div class="categories-title-container">
            <div class="categories-title-left-container">
                <i class="fa fa-th-large" style="font-size:24px; margin-right: 10px;"></i> <h3>Categories</h3>
            </div>
        ...
        <div class="video-grid">
            ...
            <?php
            $sql = "SELECT * FROM movies WHERE section = 'Ready'";  // Change the section as needed
                    ...
                    echo '<div class="video-card" data-category="' . htmlspecialchars($row['category']) . '">';
                        ...
                        echo "<div class='like-button'>";
                            echo '<div class="info">';
                                ...
                                echo "</div>";
                            echo "</div>";
                        echo '<button class="like-btn" data-movie-id="' . htmlspecialchars($row['id']) . '">Like</button>';
                        echo "</div>";
                    echo "</div>";
    ...
    <script src="view/arrows.js"></script>
</body>
</html>